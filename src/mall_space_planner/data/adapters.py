...
def _build_case_db(
    ...
    manifest = {
        ...
        "extra_metric_cols": [c for c in spec.extra_metric_cols if c in df.columns],
        "passthrough_cols": [c for c in spec.passthrough_cols if c in df.columns],
        "layout_col": spec.layout_col,
